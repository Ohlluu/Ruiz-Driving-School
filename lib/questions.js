// =============================================
// Question banks — server side only.
//
// These used to live in script.js, which meant every visitor's browser
// downloaded all four tests and their answer keys before the password screen
// even appeared. They are now served by /api/questions, and only to a request
// carrying a valid instructor session.
//
// Nothing else about the banks changed in the move; the content is identical.
// =============================================
